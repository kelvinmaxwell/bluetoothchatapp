...
public class BluetoothChatFragment extends Fragment {
    ...
    public interface UpdateDataMonitor {
        public void UpdateDataMonitorToActivity(CvtDataDump cvtDataDump);
    ...
    private void setupChat() {
        ...
        mConversationArrayAdapter = new ArrayAdapter<String>(getActivity(), R.layout.message_layout);
        ...
        private void NextAction() {
            switch (m_iNextAction) {
                ...
                case Constants.CVTDIAG_NEXT_DTC_STEP9_RESULT: {
                    ...
                    Log.d("sIncomingBufferLocalCopy",sIncomingBufferLocalCopy);
                    m_sWaitingForString = "";
                    ...
                    if ( sIncomingBufferLocalCopy.length()==4 && sIncomingBufferLocalCopy.substring(0,4).equals("5700") ) {
                        ...
                        if (sIncomingBufferLocalCopy.length()>=4 && sIncomingBufferLocalCopy.substring(0,2).equals("57")) {
                            ...
                            Log.d("detected",sIncomingBufferLocalCopy);
...
//                        mConversationArrayAdapter.clear();
                ...
                case Constants.CVTDIAG_NEXT_READPARAMS_STEP9_RESULT: {
                    ...
                    if (data.IsDumpValid()) {
                       ...
                       Log.d("found","updates valid next");
                ...
                case Constants.CVTDIAG_NEXT_READECU_STEP6_ATSH8110FC: {
                    sendMessage(" ATSH8110FC\r"); // Setting header for accessing EC
                    Log.d("passed 6","true");
